...
//   if (argc == 1)
//   {
//     fprintf(stderr, "Purpose: Concurrency Problems - choose a valid option -p, -d, -b\n");
//     return 1;
//   }
...
//       if (argc <= 2)
//       {
//         fprintf(stderr, "Purpose: Concurrency Problems -p, choose a valid option -n, -c\n");
//         return 1;
//       }
...
/* 
COMPILE:
gcc --std=gnu99 -Wall -pthread -o Knight_Concurrency concurrency_problems.c
